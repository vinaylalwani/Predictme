...
orig_w1_data=fread('/Users/vinaylalwani/per/projects/ml/SR/v8.0_W1.csv')
orig_w12_data=fread('/Users/vinaylalwani/per/projects/ml/SR/v8.0_W12.csv')
w1_data = orig_w1_data[`Sales ID` != '#N/A' & `State` != 'Unspecified'][order(`Sales ID`)]
w1_data = w1_data[, ("Sales ID") := lapply(.SD, as.numeric), .SDcols = "Sales ID"]
...
sampleDataSet = sampleDataSet[, c(FALSE,TRUE,FALSE,TRUE,FALSE,TRUE,FALSE)]
